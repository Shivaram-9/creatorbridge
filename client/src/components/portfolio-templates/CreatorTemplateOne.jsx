  ...
  return (
    <div className="p-12 font-sans text-slate-800 dark:text-white bg-white" style={{ minHeight: '100%' }}>
      ...
      <header className="border-b-4 border-blue-600 pb-6 mb-8 flex justify-between items-end">
        <div>
          <h1 className="text-5xl font-black text-slate-900 dark:text-white mb-2 uppercase tracking-tight">{data.personal.name || "YOUR NAME"}</h1>
      ...
      <div className="flex gap-12">
        ...
        <div className="w-2/3 space-y-10">
          ...
          {data.experience.length > 0 && (
            <section>
              <h3 className="text-xl font-bold uppercase tracking-widest text-slate-900 dark:text-white border-b-2 border-slate-200 pb-2 mb-6">Experience</h3>
          ...
          {data.projects.length > 0 && (
            <section>
              <h3 className="text-xl font-bold uppercase tracking-widest text-slate-900 dark:text-white border-b-2 border-slate-200 pb-2 mb-6">Key Projects</h3>
              <div className="space-y-6">
        ...
        <div className="w-1/3 space-y-10">
          ...
          {data.skills.length > 0 && (
            <section>
              <h3 className="text-xl font-bold uppercase tracking-widest text-slate-900 dark:text-white border-b-2 border-slate-200 pb-2 mb-6">Expertise</h3>
          ...
          {data.education.length > 0 && (
            <section>
              <h3 className="text-xl font-bold uppercase tracking-widest text-slate-900 dark:text-white border-b-2 border-slate-200 pb-2 mb-6">Education</h3>
              <div className="space-y-4">
                {data.education.map(edu => (
                  <div key={edu.id}>
                    <h4 className="text-md font-bold text-slate-800 dark:text-white">{edu.degree}</h4>
