    ...
    <div className="p-0 font-sans text-slate-800 dark:text-white bg-white min-h-[297mm] flex flex-col">
      ...
      <header className="relative bg-white pt-16 px-16 pb-8 border-b-8 border-red-600">
        ...
        <div className="flex justify-between items-end">
          <div className="w-2/3">
            <h1 className="text-6xl font-black text-slate-900 dark:text-white tracking-tighter uppercase mb-2">{data.personal.name || "COMPANY"}</h1>
          ...
          <div className="w-1/3 text-right text-sm font-semibold text-slate-500 space-y-1">
            ...
            {data.personal.website && <p className="text-slate-900 dark:text-white">{data.personal.website}</p>}
          </div>
        </div>
      </header>
            ...
            <section>
              ...
              <ul className="space-y-3">
                {data.skills.map(skill => (
                  <li key={skill} className="flex items-center text-sm font-bold text-slate-800 dark:text-white">
