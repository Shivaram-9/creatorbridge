          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden flex flex-col" onClick={e => e.stopPropagation()}>
            <div className="px-6 py-5 border-b border-gray-100 flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-slate-500 mt-1">Send a request to our support team.</p>
              </div>
              <button onClick={() => setShowHelpCenter(false)} className="text-gray-400 hover:text-gray-700 transition-colors p-2 bg-gray-50 rounded-full">
            ...
            <form onSubmit={handleHelpSubmit} className="p-6 flex flex-col gap-4">
              ...
              <div className="bg-blue-50 text-blue-800 p-4 rounded-xl text-sm flex gap-3 items-start mt-2">
