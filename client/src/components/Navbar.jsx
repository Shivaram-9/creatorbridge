...
export default function Navbar({ user, searchQuery, setSearchQuery, handleSearch, unreadCount, menuOpen, setMenuOpen, menuRef, logout }) {
  ...
  const dummyNotifications = [
    { id: 1, text: "Sarah Jenkins liked your post", time: "2m ago", icon: "❤️" },
    { id: 2, text: "New connection request from David Miller", time: "1h ago", icon: "👥" },
    { id: 3, text: "Global Brands Co viewed your profile", time: "3h ago", icon: "👀" },
  ];
