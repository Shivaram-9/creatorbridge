...
/**
 * VerifiedBadge - A premium blue verified badge for creators and brands.
 * @param {string} size - Size of the badge (sm, md, lg)
 * @param {boolean} showTooltip - Whether to show the "Verified" tooltip on hover
 */
export default function VerifiedBadge({ size = 'md', showTooltip = true }) {
  const sizes = {
    xs: '12px',
    sm: '14px',
    md: '16px',
  ...
  return (
    <span 
      ...
      title={showTooltip ? "Verified Creator" : ""}
      style={{
        display: 'inline-flex',
        alignItems: 'center',
        justifyContent: 'center',
        marginLeft: '4px',
        color: '#1d9bf0', // Premium Twitter-style blue
        flexShrink: 0,
