        ...
        <div style={{ background: 'rgba(245, 158, 11, 0.1)', padding: '16px', borderRadius: '12px', border: '1px solid rgba(245, 158, 11, 0.2)', width: '100%', maxWidth: '400px' }}>
          ...
          <div style={{ marginTop: '12px' }}>
            {(() => {
              ...
              // Always show just the View Proposal button which opens the Modal where actions live
              return (
                <button 
                  onClick={() => {
                  ...
                  style={{ background: '#f59e0b', color: '#fff', border: 'none', padding: '12px 16px', borderRadius: '8px', fontWeight: '600', fontSize: '13px', cursor: 'pointer', width: '100%' }}
                >
                  View Proposal
                </button>
              );
