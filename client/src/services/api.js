...
export const api = {
  ...
  users: {
    ...
    getRelatedSuggestions: () => request("/users/discover/related-suggestions"),
  ...
  campaigns: {
    ...
    apply: (id, formData) => request(`/campaigns/apply/${id}`, { method: "POST", body: formData }),
    getMyApplications: () => request("/campaigns/applications/me"),
    getApplicants: (campaignId) => request(`/campaigns/applicants/${campaignId}`),
    getBrandApplications: () => request("/campaigns/applications/brand"),
